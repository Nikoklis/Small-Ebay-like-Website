...
<body>
	...
	<div id="main">	
		<h2>
			Please re-enter any values to edit them:
		</h2>
		<form name=infoinput action=AucManipulate method="post" >
			...
			<input type="file" name="Aucpics" multiple accept="image/*">
			<br><br>
			<label>Description:</label><br>
			<textarea name="AucDesc" form=infoinput rows="10" cols="50"> </textarea><br><br>
