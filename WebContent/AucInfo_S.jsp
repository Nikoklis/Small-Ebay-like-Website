...
<body>
	...
	<div id="main">
		...
		<tr>
		 ...
		 <tr>
		    <th>Started:</th>
		    <td><c:out value="${auc.started }"></c:out></td>
		 </tr>
		 <tr>
		    <th>Ends:</th>
		    <td><c:out value="${auc.ends }"></c:out></td>
		 </tr>
		 <tr>
		    <th>No Bids</th>
		    <td><c:out value="${auc.number_of_Bids }"></c:out></td>
		 </tr>
		 <tr>
		    <th>Description:</th>
	...
	<div style="text-align:center">
		<form action=Bids  method=get>
				...
				<input type="hidden" name="function" value="seller">	
				<input class=con type="submit" value="Inspect Bids">
			</form>
	</div>
